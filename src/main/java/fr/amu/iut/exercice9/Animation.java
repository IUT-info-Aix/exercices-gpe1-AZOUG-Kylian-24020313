...
//        SequentialTransition st = new SequentialTransition(transition1, transition2, transition3, transition4, transition5);
        ...
        SequentialTransition loop = new SequentialTransition(transition1, transition2, transition3, transition4, transition5, transition6, transition7);
        loop.setCycleCount(2);
        loop.setAutoReverse(true);
        customButton.addOnMousePressed(e -> loop.play());
